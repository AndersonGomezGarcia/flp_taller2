;;Anderson Gomez Garcia 2266242;;Kevin Alexis Lorza Ramirez 2266098 ;;Juan David Perez Valencia 2266289;; Jesus Ediber Arenas Guzman 2266066 - Taller 2
#lang eopl
...
(define especificacion-gramatical
  '(
    ...
    ;;Listas
    (expresion ("list" "(" (separated-list expresion ",") ")") list-exp)
    ...
    ;;Condicionales
    (expresion ("cond" (arbno expresion "==>" expresion ) "else" "==>" expresion "end") cond-exp)    ;;Primitivas
      ...
      (cons-exp (e1 e2)
        (let* ([v1 (evaluar-expresion e1 amb)] ;; Evalúa el primer argumento
          ...
          (if (list? v2)                       ;; Verifica que el segundo argumento sea una lista
              ...
              (eopl:error "Error: el segundo argumento de cons no es una lista" v2)))) ;; Error si no es lista
